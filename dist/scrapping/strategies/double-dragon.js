...
let DoubleDragon = class DoubleDragon extends abstract_game_scrapper_1.AbstractGameScraper {
    constructor(mongoResultModel) {
        super();
        this.mongoResultModel = mongoResultModel;
        this.gameName = 'double_dragon';
    }
    getUrl() {
...
exports.DoubleDragon = DoubleDragon;
exports.DoubleDragon = DoubleDragon = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(mongo_result_schema_1.MongoResult.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], DoubleDragon);
//# sourceMappingURL=double-dragon.js.map