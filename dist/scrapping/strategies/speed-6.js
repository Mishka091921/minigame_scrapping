...
let Speed6 = class Speed6 extends abstract_game_scrapper_1.AbstractGameScraper {
    constructor(mongoResultModel) {
        super();
        this.mongoResultModel = mongoResultModel;
        this.gameName = 'speed_6';
    }
    getUrl() {
